...
class Login extends React.PureComponent {
    ...
    onSubmit = (e) => {
        if(this.state.email === this.state.correctName && this.state.password === this.state.correctPass){
            <SignUp />
        }else{
                            ...
                            <form className="login100-form validate-form">
                                ...
                                <div className="wrap-input100 validate-input" data-validate="Valid email is required: ex@abc.xyz">
                                    <input className="input100" type="text" name="email" value={this.state.email}
                                        onChange={e => this.handleChange(e)} placeholder="Email" />
                                ...
                                <div className="text-center p-t-136">
                                    ...
                                    <p><NavLink to="/">Create your Account</NavLink></p>
